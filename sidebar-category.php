            ...
            <?php
                ...
                foreach ($result as $row) {
                    ...
                    <li class="cat-level-1 deeper parent" >
                        <a class=""  style="background-color: #6d5d6e;" href="product-category.php?id=<?php echo $row['tcat_id'] ; ?>&type=top-category">
                            <span data-toggle="collapse" data-parent="#menu-group-1" href="#cat-lvl1-id-<?php echo $i; ?>" class="sign" style="background-color: #6d5d6e;"><i class="fa fa-plus"></i></span>
