...
<div class="header" style="background-color: #6d5d6e;">
		<div class="row inner">
			<div class="col-md-4 logo">
			<a href="index.php"><img src="assets/uploads/<?php echo $logo; ?>" alt="logo image"><span style="color: white; font-size: 34px; font-family: 'Archivo Black';margin-left: 10px;margin-top: 20px;">LIMAAWAKTU</span></a>
			</div>
			...
			<div class="col-md-9 search-area" >
...
<div class="nav" style="background-color: #6d5d6e;">
		<div class="row">
			<div class="col-md-12 pl_0 pr_0 ">
				<div class="menu-container">
					<div class="menu" style="background-color: #6d5d6e;">
						<ul>
							...
							<li style="background-color: #6d5d6e;"><a href="about.php"><?php echo $about_title; ?></a></li>
